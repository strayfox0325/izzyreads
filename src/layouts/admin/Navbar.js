...
const Navbar = () => {
    ...
    return (
        <nav className="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <button className="btn btn-link btn-sm order-1 order-lg-0 me-4 me-lg-0" id="sidebarToggle" ref={refContainer}><i
            ...
            <ul className="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li className="nav-item dropdown">
                    <Link className="nav-link dropdown-toggle" id="navbarDropdown" to="#" role="button"
                          data-bs-toggle="dropdown" aria-expanded="false"><i className="fas fa-user fa-fw"/></Link>
